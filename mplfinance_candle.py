...
for stock in selected_stocks:
    ...
    ap = [mpl.make_addplot(dataframe1, type='candle', panel=1, alpha=1)]
    farsi = get_display(reshape(stock))
    print(farsi)
    mpl.plot(dataframe2, type='candle', volume=True, volume_panel=2, title=farsi, addplot=ap)
